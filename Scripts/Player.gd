...
var maxSpeed = 380 #maximum current speed can reach when moving horizontally
...
var airFriction = 30 #how much you subtract velocity when you start moving horizontally in the air
...
#jump
var jumpHeight = 128  #How high the peak of the jump is in pixels
...
#wall slide
var wallSlideSpeed = 100 #how fast you slide on a wll
